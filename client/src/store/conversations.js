...
export const setNewMessage = (message, sender, isSenderCurUser) => {
  return {
    type: SET_MESSAGE,
    payload: { message, sender: sender || null, isSenderCurUser },
  };
};
...
export const setClearUnreadConversation = (conversationId) => {
  return {
    type: CLEAR_UNREAD_CONVERSATION,
    conversationId,
  }
}
